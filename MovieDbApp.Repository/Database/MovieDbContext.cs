    ...
    public class MovieDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>().HasData(new Role[]
            {
                ...
                new Role("275#18#17#10#Ramonda"),
                new Role("276#18#86#11#Zuri"),
                new Role("277#18#16#12#Ulysses Klaue"),
                new Role("278#18#83#13#Ayo"),
                new Role("279#18#124#14#T'Chaka"),
                new Role("280#18#65#15#Limbani"),
                new Role("281#18#184#16#Linda"),
                new Role("282#18#108#17#River Tribe Elder"),
                new Role("283#18#57#18#Mining Tribe Elder"),
                new Role("284#19#212#1#Tony Stark"),
                new Role("285#19#46#2#Thor"),
                new Role("286#19#166#3#Bruce Banner"),
                new Role("287#19#45#4#Steve Rogers"),
                new Role("288#19#221#5#Natasha Romanoff"),
                new Role("289#19#71#6#James Rhodes"),
                new Role("290#19#29#7#Doctor Strange"),
                new Role("291#19#247#8#Peter Parker"),
                new Role("292#19#42#9#T'Challa"),
                new Role("293#19#273#10#Gamora"),
                new Role("294#19#132#11#Nebula"),
                new Role("295#19#246#12#Loki"),
                new Role("296#19#190#13#Vision"),
                new Role("297#19#75#14#Wanda Maximoff"),
                new Role("298#19#22#15#Sam Wilson"),
                new Role("299#19#224#16#Bucky Barnes"),
                new Role("300#19#107#17#Heimdall"),
                new Role("301#19#59#18#Okoye"),
                new Role("302#20#191#1#Scott Lang"),
                new Role("303#20#79#2#Hope Van Dyne"),
                new Role("304#20#177#3#Luis"),
                new Role("305#20#261#4#Sonny Burch"),
                new Role("306#20#35#5#Paxton"),
                new Role("307#20#131#6#Maggie"),
                new Role("308#20#234#7#Dave"),
                new Role("309#20#63#8#Kurt"),
                new Role("310#20#100#9#Ava"),
                new Role("311#20#3#10#Cassie"),
                new Role("312#20#203#11#Jimmy Woo"),
                new Role("313#20#181#12#Janet Van Dyne"),
                new Role("314#20#148#13#Dr. Bill Foster"),
                new Role("315#20#175#14#Dr. Hank Pym"),
                new Role("316#20#68#15#Uzman"),
                new Role("317#20#93#16#Anitolov"),
                new Role("318#21#39#1#Carol Danvers"),
                new Role("319#21#219#2#Nick Fury"),
                new Role("320#21#28#3#Talos"),
                new Role("321#21#130#4#Yon-Rogg"),
                new Role("322#21#20#5#Supreme Intelligence"),
                new Role("323#21#69#6#Korath"),
                new Role("324#21#149#7#Ronan"),
                new Role("325#21#144#8#Maria Rambeau"),
                new Role("326#21#90#9#Minn-Erva"),
                new Role("327#21#53#10#Agent Coulson"),
                new Role("328#21#215#11#Bron-Char"),
                new Role("329#21#10#12#Att-Lass"),
                new Role("330#22#212#1#Tony Stark"),
                new Role("331#22#45#2#Steve Rogers"),
                new Role("332#22#166#3#Bruce Banner"),
                new Role("333#22#46#4#Thor"),
                new Role("334#22#221#5#Natasha Romanoff"),
                new Role("335#22#120#6#Clint Barton"),
                new Role("336#22#71#7#James Rhodes"),
                new Role("337#22#191#8#Scott Lang"),
                new Role("338#22#29#9#Doctor Strange"),
                new Role("339#22#42#10#T'Challa"),
                new Role("340#22#39#11#Carol Danvers"),
                new Role("341#22#247#12#Peter Parker"),
                new Role("342#22#132#13#Nebula"),
                new Role("343#22#273#14#Gamora"),
                new Role("344#22#79#15#Hope Van Dyne"),
                new Role("345#22#238#16#Valkyrie"),
                new Role("346#22#208#17#Frigga"),
                new Role("347#22#75#18#Wanda Maximoff"),
                new Role("348#23#247#1#Peter Parker"),
                new Role("349#23#219#2#Nick Fury"),
                new Role("350#23#113#3#Quentin Beck"),
                new Role("351#23#164#4#May Parker"),
                new Role("352#23#126#5#Happy Hogan"),
                new Role("353#23#272#6#MJ"),
                new Role("354#23#111#7#Ned Leeds"),
                new Role("355#23#252#8#Flash Thompson"),
                new Role("356#23#19#9#Betty Brant"),
                new Role("357#23#207#10#Brad Davis"),
                new Role("358#23#169#11#Mr. Harrington"),
                new Role("359#23#109#12#Mr. Dell"),
                new Role("360#23#128#13#Jason Ionello"),
                new Role("361#23#55#14#Maria Hill"),
                new Role("362#23#187#15#Dimitri"),
                new Role("363#23#269#16#Zach"),
                new Role("364#23#274#17#Zoha"),
                new Role("365#23#268#18#Yasmin"),
                new Role("366#24#221#1#Natasha Romanoff"),
                new Role("367#24#84#2#Yelena Belova"),
                new Role("368#24#64#3#Alexei"),
                new Role("369#24#201#4#Melina"),
                new Role("370#24#205#5#Dreykov"),
                new Role("371#24#80#6#Young Natasha"),
                new Role("372#24#259#7#Young Yelena"),
                new Role("373#24#189#8#Mason"),
                new Role("374#24#264#9#Secretary Ross"),
                new Role("375#24#188#10#Antonia…"),
                new Role("376#24#216#11#Young Antonia"),
                new Role("377#24#155#12#Lerato"),
                new Role("378#24#180#13#Oksana"),
                new Role("379#24#152#14#Scientist Morocco 1"),
                new Role("380#25#227#1#Shaun"),
                new Role("381#25#25#2#Katy"),
                new Role("382#25#251#3#Xu Wenwu"),
                new Role("383#25#27#4#Trevor Slattery"),
                new Role("384#25#173#5#Xialing"),
                new Role("385#25#81#6#Li"),
                new Role("386#25#182#7#Ying Nan"),
                new Role("387#25#260#8#Master Guang Bo"),
                new Role("388#25#85#9#Razor Fist"),
                new Role("389#25#15#10#Death Dealer"),
                new Role("390#25#193#11#Chancellor Hui"),
                new Role("391#25#117#12#Young Shang-Chi"),
                new Role("392#25#76#13#Young Xialing"),
                new Role("393#25#24#14#Teen Shang-Chi"),
                new Role("394#25#230#15#Soo"),
                new Role("395#25#142#16#John"),
                new Role("396#25#254#17#Waipo"),
                new Role("397#25#122#18#Mrs. Chen"),
                new Role("398#26#90#1#Sersi"),
                new Role("399#26#211#2#Ikaris"),
                new Role("400#26#18#3#Thena"),
                new Role("401#26#217#4#Ajak"),
                new Role("402#26#139#5#Dane Whitman"),
                new Role("403#26#141#6#Kingo"),
                new Role("404#26#154#7#Sprite"),
                new Role("405#26#38#8#Phastos"),
                new Role("406#26#147#9#Makkari"),
                new Role("407#26#26#10#Druig"),
                new Role("408#26#161#11#Gilgamesh"),
                new Role("409#26#102#12#Karun"),
                new Role("410#26#33#13#Kro"),
                new Role("411#26#97#14#Ben"),
                new Role("412#26#78#15#Jack"),
                new Role("413#26#104#16#Eros"),
                new Role("414#26#8#17#Patrick"),
                new Role("415#26#98#18#Sandra"),
                new Role("416#27#247#1#Peter Parker / Spider-Man"),
                new Role("417#27#272#2#MJ"),
                new Role("418#27#29#3#Doctor Strange"),
                new Role("419#27#111#4#Ned Leeds"),
                new Role("420#27#126#5#Happy Hogan"),
                new Role("421#27#116#6#Max Dillon / Electro"),
                new Role("422#27#263#7#Norman Osborn / Green Goblin"),
                new Role("423#27#9#8#Dr. Otto Octavius / Doc Ock"),
                new Role("424#27#30#9#Wong"),
                new Role("425#27#252#10#Flash Thompson"),
                new Role("426#27#164#11#May Parker"),
                new Role("427#27#14#12#Peter Parker / Spider-Man"),
                new Role("428#27#244#13#Peter Parker / Spider-Man"),
                new Role("429#27#19#14#Betty Brant"),
                new Role("430#27#23#15#Agent Cleary"),
                new Role("431#27#194#16#MIT Assistant Vice Chancellor"),
                new Role("432#27#101#17#Coach Wilson"),
                new Role("433#27#169#18#Mr. Harrington"),
                new Role("434#27#103#19#Apprentice"),
                new Role("435#27#109#20#Mr. Dell"),
                new Role("436#27#110#21#J. Jonah Jameson"),
                new Role("437#27#209#22#Dr. Curt Connors / The Lizard"),
                new Role("438#27#170#23#Ned's Lola"),
                new Role("439#27#43#24#Matt Murdock"),
                new Role("440#27#135#25#Arena Bystander"),
                new Role("441#27#239#26#Flint Marko / Sandman"),
